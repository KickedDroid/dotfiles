...
alias display="xrandr --output Virtual-1 --mode \"1920x1080\""

alias tun0ip="ifconfig tun0 | grep 'inet ' | cut -d' ' -f10 | tr -d '\n'"
alias tun0="ifconfig tun0 | grep 'inet ' | cut -d' ' -f10 | tr -d '\n' | xclip -sel clip"
alias http-server="list_ips && ls_pwd && sudo python3 -m http.server 8000"
alias ptty="echo \"python3 -c 'import pty;pty.spawn(\"/bin/bash\")'\"| xclip -sel clip && echo hi"
alias vpn="sudo openvpn /home/droid/Documents/vpns/labs_kd.ovpn"
alias get_vhost="vhost"
alias chiselS="chisel_forward"
